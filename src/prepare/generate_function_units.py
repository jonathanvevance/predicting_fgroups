...
dataFolder = '../../data/raw/MIT_USPTO'
writeFolder = '../../data/external'

df_seq = pd.read_csv(dataFolder + '/chembl_28_chemreps.txt', delimiter='\t')

freq_codes = []
vocab_index2units2freq = {}
seq = (df_seq.canonical_smiles.values)

output = open(writeFolder + '/drug_codes_chembl_1500.txt', 'w+')

learn_bpe(seq, output, 30000, min_frequency=3000, verbose=True, is_dict=False, total_symbols=True)
...
sub_csv.to_csv(writeFolder + '/subword_units_map_chembl_freq_1500.csv')
